...
public class ProcessOrderCommand implements Command {
    ...
    public String execute(IRequestWrapper wrapper) {
        Car car = (Car) wrapper.getSessionAttribute(SessionAttributes.CAR);
        CarFilter carFilter = (CarFilter) wrapper.getSessionAttribute(SessionAttributes.CAR_FILTER);
        String startDateString = wrapper.getParameter("start_date");
        String endDateString = wrapper.getParameter("end_date");

        if (car == null || carFilter == null || startDateString == null || endDateString == null) {
            ...
            //calculate price
            Integer daysDiff = DateUtils.getDiffInDays(startDate, endDate);
            ...
            if (DAOFactory.getInstance().getOrdersDAO().addOrder(order)) {
                wrapper.removeSessionAttribute(SessionAttributes.CAR);
